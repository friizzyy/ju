...
export default function SystemsPage() {
  return (
    <>
      ...
      <section className="min-h-[100svh] flex items-center relative overflow-x-hidden px-5 sm:px-6 pt-14 sm:pt-0">
            ...
            <div>
              ...
              <Reveal delay={0.7}>
                <div className="flex items-center gap-3 mt-4 sm:mt-10">
                  <MagneticButton>
                    <Link
                      href="https://calendly.com/julius-buildwithju/systems-audit-45-min"
                      target="_blank"
